...
//                       Библиотека  "multer"
//!!! ПОльзуемся версией мультера 1.4.3  -  так как она более стабильная.
//Библиотека тоже позволяет работать с файлами но и даут более широкий функционал для работы с Стримами.
...
//                      Создания бакет, полиси в сиситеме AVS
